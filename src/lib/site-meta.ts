...
export const siteMeta: SiteMeta = {
	...
	summary: "City Gate Capital is a published financial-technology platform for secure profiles, multi-currency interfaces, wallets, transfer workflows, card controls and administration; regulated financial execution requires approved providers.",
};
