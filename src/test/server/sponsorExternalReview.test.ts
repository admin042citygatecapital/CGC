...
describe('independent sponsor reviewer', () => {
  ...
  it('returns only submitted evidence metadata and keeps identities and operations isolated', async () => {
    ...
    expect(serialized).toContain('"evidenceClass":"operating_evidence"');
