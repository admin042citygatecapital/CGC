...
import admin_onboarding_sandbox_get from "./api/admin/onboarding/sandbox/GET";
import admin_onboarding_sandbox_post from "./api/admin/onboarding/sandbox/POST";
...
import users_2fa_disable_post from "./api/users/2fa/disable/POST";
...
app.get("/api/admin/onboarding/sandbox", admin_onboarding_sandbox_get);
app.post("/api/admin/onboarding/sandbox", admin_onboarding_sandbox_post);
...
app.post("/api/users/2fa/disable", users_2fa_disable_post);
