...
import admin_cards_reencrypt_post_20b from "./api/admin/cards/reencrypt/POST";
...
import admin_email_health_get_41b from "./api/admin/email/health/GET";
...
import admin_kyc_userid_get_57b from "./api/admin/kyc/[userId]/GET";
import admin_kyc_analytics_get_67b from "./api/admin/kyc/analytics/GET";
...
import admin_kyc_queue_export_get_62b from "./api/admin/kyc/queue/export/GET";
...
import admin_security_logs_get_94b from "./api/admin/security/logs/GET";
...
import admin_smartsupp_agents_get_112 from "./api/admin/smartsupp/agents/GET";
import admin_smartsupp_agents_post_113 from "./api/admin/smartsupp/agents/POST";
import admin_smartsupp_analytics_get_114 from "./api/admin/smartsupp/analytics/GET";
import admin_smartsupp_config_get_115 from "./api/admin/smartsupp/config/GET";
import admin_smartsupp_config_post_116 from "./api/admin/smartsupp/config/POST";
import admin_smartsupp_conversations_get_117 from "./api/admin/smartsupp/conversations/GET";
import admin_smartsupp_conversations_post_118 from "./api/admin/smartsupp/conversations/POST";
import admin_smartsupp_faq_get_119 from "./api/admin/smartsupp/faq/GET";
import admin_smartsupp_faq_post_120 from "./api/admin/smartsupp/faq/POST";
import admin_smartsupp_tickets_get_121 from "./api/admin/smartsupp/tickets/GET";
import admin_smartsupp_tickets_post_122 from "./api/admin/smartsupp/tickets/POST";
...
import admin_tickets_ticketId_replies_get_160 from "./api/admin/tickets/[ticketId]/replies/GET";
import admin_tickets_ticketId_reply_post_161 from "./api/admin/tickets/[ticketId]/reply/POST";
...
import admin_trading_logs_get_167b from "./api/admin/trading/logs/GET";
...
import config_smartsupp_key_get_206 from "./api/config/smartsupp-key/GET";
...
import market_summary_get_214 from "./api/market/summary/GET";
import market_ticker_get_215 from "./api/market/ticker/GET";
import newsletter_send_sequence_post_216 from "./api/newsletter/send-sequence/POST";
import newsletter_subscribe_post_217 from "./api/newsletter/subscribe/POST";
import newsletter_subscribers_get_218 from "./api/newsletter/subscribers/GET";
import newsletter_unsubscribe_get_219 from "./api/newsletter/unsubscribe/GET";
import og_get_220 from "./api/og/GET";
import settings_rates_get_221 from "./api/settings/rates/GET";
import settings_social_get_222 from "./api/settings/social/GET";
import test_email_post_223 from "./api/test-email/POST";
import users_2fa_setup_post_224 from "./api/users/2fa/setup/POST";
import users_2fa_verify_post_225 from "./api/users/2fa/verify/POST";
import users_avatar_post_226 from "./api/users/avatar/POST";
import users_balance_get_227 from "./api/users/balance/GET";
import users_beneficiaries_get_228 from "./api/users/beneficiaries/GET";
import users_beneficiaries_add_post_229 from "./api/users/beneficiaries/add/POST";
import users_beneficiaries_delete_post_230 from "./api/users/beneficiaries/delete/POST";
import users_beneficiaries_update_post_231 from "./api/users/beneficiaries/update/POST";
import users_cards_get_232 from "./api/users/cards/GET";
import users_cards_delete_post_233 from "./api/users/cards/delete/POST";
import users_cards_freeze_post_234 from "./api/users/cards/freeze/POST";
import users_cards_generate_post_235 from "./api/users/cards/generate/POST";
import users_cards_request_post_236 from "./api/users/cards/request/POST";
import users_deposit_post_237 from "./api/users/deposit/POST";
import users_devices_get_238 from "./api/users/devices/GET";
import users_devices_revoke_post_239 from "./api/users/devices/revoke/POST";
import users_kyc_document_post_240 from "./api/users/kyc-document/POST";
import users_kyc_status_get_240c from "./api/users/kyc/status/GET";
import users_kyc_submit_post_240d from "./api/users/kyc/submit/POST";
import users_kyc_upload_url_post_240e from "./api/users/kyc/upload-url/POST";
import users_tickets_post_240b from "./api/users/tickets/POST";
import users_login_post_241 from "./api/users/login/POST";
import users_login_history_get_242 from "./api/users/login-history/GET";
import users_logout_post_243 from "./api/users/logout/POST";
import users_me_patch_244 from "./api/users/me/PATCH";
import users_notifications_get_245 from "./api/users/notifications/GET";
import users_notifications_delete_post_246 from "./api/users/notifications/delete/POST";
import users_notifications_preferences_get_247 from "./api/users/notifications/preferences/GET";
import users_notifications_preferences_post_248 from "./api/users/notifications/preferences/POST";
import users_notifications_read_post_249 from "./api/users/notifications/read/POST";
import users_password_reset_post_250 from "./api/users/password-reset/POST";
import users_password_reset_confirm_post_251 from "./api/users/password-reset/confirm/POST";
import users_profile_get_252b from "./api/users/profile/GET";
import users_profile_put_252 from "./api/users/profile/PUT";
import users_register_post_253 from "./api/users/register/POST";
import users_security_events_get_254 from "./api/users/security/events/GET";
import users_security_sessions_get_255 from "./api/users/security/sessions/GET";
import users_security_sessions_revoke_post_256 from "./api/users/security/sessions/revoke/POST";
import users_session_get_257 from "./api/users/session/GET";
import users_support_get_258 from "./api/users/support/GET";
import users_support_post_259 from "./api/users/support/POST";
import users_swap_post_260 from "./api/users/swap/POST";
import users_trading_alerts_get_261 from "./api/users/trading/alerts/GET";
import users_trading_alerts_post_262 from "./api/users/trading/alerts/POST";
import users_trading_analytics_get_263 from "./api/users/trading/analytics/GET";
import users_trading_history_get_264 from "./api/users/trading/history/GET";
import users_trading_market_data_get_265 from "./api/users/trading/market-data/GET";
import users_trading_orders_get_266 from "./api/users/trading/orders/GET";
import users_trading_orders_post_267 from "./api/users/trading/orders/POST";
import users_trading_orders_cancel_post_268 from "./api/users/trading/orders/cancel/POST";
import users_trading_portfolio_get_269 from "./api/users/trading/portfolio/GET";
import users_trading_summary_get_270 from "./api/users/trading/summary/GET";
import users_trading_watchlist_get_271 from "./api/users/trading/watchlist/GET";
import users_trading_watchlist_post_272 from "./api/users/trading/watchlist/POST";
import users_transactions_get_273 from "./api/users/transactions/GET";
import users_transfer_post_274 from "./api/users/transfer/POST";
import users_transfers_get_275 from "./api/users/transfers/GET";
import users_transfers_post_276 from "./api/users/transfers/POST";
import users_verify_email_get_277 from "./api/users/verify-email/GET";
import users_wallet_overview_get_278 from "./api/users/wallet-overview/GET";
import users_withdraw_post_279 from "./api/users/withdraw/POST";
import zoho_callback_get_280 from "./api/zoho/callback/GET";
import zoho_connect_get_281 from "./api/zoho/connect/GET";
import zoho_status_get_282 from "./api/zoho/status/GET";
// </api-imports>
import { startEmailQueueWorker } from "./lib/emailQueue";
import { requireAdminAuth } from "./lib/adminAuthMiddleware";
import { requireRole, requireSuperAdmin } from "./lib/rbacMiddleware";
import { sendEmail as smtpSendEmail } from "./lib/smtpTransport";
import { seoRoutes } from "../lib/seo-routes";
import { logStartupCredentialState } from "./lib/zohoTokenStore";
import { syncSecretsIntoConfig } from "./lib/smtpConfigStore";
...
app.use(compression({
  ...
  filter: (req, res) => {
    ...
    if (ct && /image\/(png|jpe?g|gif|webp|avif)|video\/|audio\/|application\/(zip|gzip|br|zstd|wasm)/.test(ct)) {
      return false;
    }
...
app.post("/api/admin/balance/adjust", requireRole('FINANCE_ADMIN'), admin_balance_adjust_post_12);
app.get("/api/admin/balance/history", admin_balance_history_get_13);
app.get("/api/admin/cards", admin_cards_get_14);
app.post("/api/admin/cards/reencrypt", requireSuperAdmin, admin_cards_reencrypt_post_20b);
app.post("/api/admin/cards/freeze", requireSuperAdmin, admin_cards_freeze_post_15);
app.post("/api/admin/cards/issue", requireSuperAdmin, admin_cards_issue_post_16);
app.post("/api/admin/cards/pin", requireSuperAdmin, admin_cards_pin_post_17);
app.post("/api/admin/cards/replace", requireSuperAdmin, admin_cards_replace_post_18);
app.post("/api/admin/cards/spending-limit", requireSuperAdmin, admin_cards_spending_limit_post_19);
...
app.post("/api/admin/config", requireSuperAdmin, admin_config_post_38);
...
app.get("/api/admin/email/health", admin_email_health_get_41b);
...
app.post("/api/admin/email/templates", requireSuperAdmin, admin_email_templates_post_50);
app.post("/api/admin/email/templates/reset", requireSuperAdmin, admin_email_templates_reset_post_51);
...
app.post("/api/admin/integrations", requireSuperAdmin, admin_integrations_post_56);
app.post("/api/admin/integrations/test", admin_integrations_test_post_57);
app.post("/api/admin/kyc/approve", requireRole('COMPLIANCE_ADMIN'), admin_kyc_approve_post_58);
app.post("/api/admin/kyc/extend", requireRole('COMPLIANCE_ADMIN'), admin_kyc_extend_post_59);
app.post("/api/admin/kyc/flag", requireRole('COMPLIANCE_ADMIN'), admin_kyc_flag_post_60);
app.post("/api/admin/kyc/note", requireRole('COMPLIANCE_ADMIN'), admin_kyc_note_post_61);
app.get("/api/admin/kyc/queue", admin_kyc_queue_get_62);
app.get("/api/admin/kyc/queue/export", admin_kyc_queue_export_get_62b);
app.post("/api/admin/kyc/reject", requireRole('COMPLIANCE_ADMIN'), admin_kyc_reject_post_63);
app.post("/api/admin/kyc/request-info", requireRole('COMPLIANCE_ADMIN'), admin_kyc_request_info_post_64);
...
app.get("/api/admin/kyc/analytics", admin_kyc_analytics_get_67b);
app.get("/api/admin/kyc/:userId", admin_kyc_userid_get_57b);
...
app.post("/api/admin/newsletter/campaigns", requireRole('SUPPORT_ADMIN'), admin_newsletter_campaigns_post_74);
app.put("/api/admin/newsletter/campaigns", requireRole('SUPPORT_ADMIN'), admin_newsletter_campaigns_put_75);
app.post("/api/admin/newsletter/campaigns/duplicate", requireRole('SUPPORT_ADMIN'), admin_newsletter_campaigns_duplicate_post_76);
app.post("/api/admin/newsletter/campaigns/send", requireRole('SUPPORT_ADMIN'), admin_newsletter_campaigns_send_post_77);
app.post("/api/admin/newsletter/subscribers/import", requireRole('SUPPORT_ADMIN'), admin_newsletter_subscribers_import_post_78);
app.post("/api/admin/newsletter/subscribers/unsubscribe", requireRole('SUPPORT_ADMIN'), admin_newsletter_subscribers_unsubscribe_post_79);
app.post("/api/admin/notifications/send", requireRole('SUPPORT_ADMIN'), admin_notifications_send_post_80);
app.get("/api/admin/rates", admin_rates_get_81);
app.get("/api/admin/rates/fee-history", admin_rates_fee_history_get_82);
app.post("/api/admin/rates/fx-markup", requireRole('FINANCE_ADMIN'), admin_rates_fx_markup_post_83);
app.post("/api/admin/rates/limits", requireRole('FINANCE_ADMIN'), admin_rates_limits_post_84);
app.get("/api/admin/rates/limits/user", admin_rates_limits_user_get_85);
app.post("/api/admin/rates/tier-fees", requireRole('FINANCE_ADMIN'), admin_rates_tier_fees_post_86);
app.post("/api/admin/rates/tx-fees", requireRole('FINANCE_ADMIN'), admin_rates_tx_fees_post_87);
...
app.post("/api/admin/security/alerts", requireRole('SECURITY_ADMIN'), admin_security_alerts_post_91);
app.delete("/api/admin/security/devices", requireRole('SECURITY_ADMIN'), admin_security_devices_delete_92);
...
app.get("/api/admin/security/logs", admin_security_logs_get_94b);
app.get("/api/admin/security/ip-lists", admin_security_ip_lists_get_95);
app.post("/api/admin/security/ip-lists", requireRole('SECURITY_ADMIN'), admin_security_ip_lists_post_96);
app.get("/api/admin/security/rate-limits", admin_security_rate_limits_get_97);
app.post("/api/admin/security/rate-limits", requireRole('SECURITY_ADMIN'), admin_security_rate_limits_post_98);
app.get("/api/admin/security/roles", admin_security_roles_get_99);
app.post("/api/admin/security/roles", requireSuperAdmin, admin_security_roles_post_100);
app.delete("/api/admin/security/sessions", requireRole('SECURITY_ADMIN'), admin_security_sessions_delete_101);
app.get("/api/admin/security/sessions", requireRole('SECURITY_ADMIN'), admin_security_sessions_get_102);
app.patch("/api/admin/security/sessions", requireRole('SECURITY_ADMIN'), admin_security_sessions_patch_103);
app.get("/api/admin/security/threats", admin_security_threats_get_104);
app.patch("/api/admin/security/threats", requireRole('SECURITY_ADMIN'), admin_security_threats_patch_105);
app.get("/api/admin/security/two-fa", admin_security_two_fa_get_106);
app.post("/api/admin/security/two-fa", requireRole('SECURITY_ADMIN'), admin_security_two_fa_post_107);
app.get("/api/admin/settings", admin_settings_get_108);
app.post("/api/admin/settings", requireSuperAdmin, admin_settings_post_109);
app.get("/api/admin/settings/rates", admin_settings_rates_get_110);
app.post("/api/admin/settings/rates", requireRole('FINANCE_ADMIN'), admin_settings_rates_post_111);
app.get("/api/admin/smartsupp/agents", admin_smartsupp_agents_get_112);
app.post("/api/admin/smartsupp/agents", admin_smartsupp_agents_post_113);
app.get("/api/admin/smartsupp/analytics", admin_smartsupp_analytics_get_114);
app.get("/api/admin/smartsupp/config", admin_smartsupp_config_get_115);
app.post("/api/admin/smartsupp/config", admin_smartsupp_config_post_116);
app.get("/api/admin/smartsupp/conversations", admin_smartsupp_conversations_get_117);
app.post("/api/admin/smartsupp/conversations", admin_smartsupp_conversations_post_118);
app.get("/api/admin/smartsupp/faq", admin_smartsupp_faq_get_119);
app.post("/api/admin/smartsupp/faq", admin_smartsupp_faq_post_120);
app.get("/api/admin/smartsupp/tickets", admin_smartsupp_tickets_get_121);
app.post("/api/admin/smartsupp/tickets", admin_smartsupp_tickets_post_122);
app.get("/api/admin/smtp/config", admin_smtp_config_get_123);
app.post("/api/admin/smtp/config", requireSuperAdmin, admin_smtp_config_post_124);
app.post("/api/admin/smtp/mode", requireSuperAdmin, admin_smtp_mode_post_125);
app.get("/api/admin/smtp/status", admin_smtp_status_get_126);
app.post("/api/admin/smtp/test", requireSuperAdmin, admin_smtp_test_post_127);
app.post("/api/admin/smtp/test-template", requireSuperAdmin, admin_smtp_test_template_post_128);
app.post("/api/admin/smtp/verify", requireSuperAdmin, admin_smtp_verify_post_129);
...
app.get("/api/admin/tickets/:ticketId/replies", admin_tickets_ticketId_replies_get_160);
app.post("/api/admin/tickets/:ticketId/reply", admin_tickets_ticketId_reply_post_161);
...
app.post("/api/admin/trading/fees", requireRole('FINANCE_ADMIN'), admin_trading_fees_post_165);
app.get("/api/admin/trading/freeze", admin_trading_freeze_get_166);
app.post("/api/admin/trading/freeze", requireRole('FINANCE_ADMIN'), admin_trading_freeze_post_167);
app.get("/api/admin/trading/logs", admin_trading_logs_get_167b);
app.get("/api/admin/trading/markets", admin_trading_markets_get_168);
app.put("/api/admin/trading/markets", requireRole('FINANCE_ADMIN'), admin_trading_markets_put_169);
app.post("/api/admin/trading/markets/suspend", requireRole('FINANCE_ADMIN'), admin_trading_markets_suspend_post_170);
app.get("/api/admin/trading/providers", admin_trading_providers_get_171);
app.put("/api/admin/trading/providers", requireRole('FINANCE_ADMIN'), admin_trading_providers_put_172);
app.get("/api/admin/transactions", admin_transactions_get_173);
app.post("/api/admin/transactions/approve", requireRole('FINANCE_ADMIN'), admin_transactions_approve_post_174);
app.post("/api/admin/transactions/create", requireRole('FINANCE_ADMIN'), admin_transactions_create_post_175);
app.post("/api/admin/transactions/freeze", requireRole('FINANCE_ADMIN'), admin_transactions_freeze_post_176);
app.get("/api/admin/transactions/real", admin_transactions_real_get_177);
app.post("/api/admin/transactions/reject", requireRole('FINANCE_ADMIN'), admin_transactions_reject_post_178);
app.get("/api/admin/users", admin_users_get_179);
app.post("/api/admin/users/action", requireRole('COMPLIANCE_ADMIN'), admin_users_action_post_180);
app.post("/api/admin/users/approve", requireRole('COMPLIANCE_ADMIN'), admin_users_approve_post_181);
app.post("/api/admin/users/create", requireSuperAdmin, admin_users_create_post_182);
app.post("/api/admin/users/currency", requireRole('FINANCE_ADMIN'), admin_users_currency_post_183);
app.post("/api/admin/users/delete", requireSuperAdmin, admin_users_delete_post_184);
app.post("/api/admin/users/edit", requireSuperAdmin, admin_users_edit_post_185);
app.post("/api/admin/users/override", requireSuperAdmin, admin_users_override_post_186);
app.post("/api/admin/users/reject", requireRole('COMPLIANCE_ADMIN'), admin_users_reject_post_187);
app.post("/api/admin/users/reset-2fa", requireSuperAdmin, admin_users_reset_2fa_post_188);
app.post("/api/admin/users/reset-password", requireSuperAdmin, admin_users_reset_password_post_189);
...
app.get("/api/config/smartsupp-key", config_smartsupp_key_get_206);
...
app.get("/api/market/summary", market_summary_get_214);
app.get("/api/market/ticker", market_ticker_get_215);
app.post("/api/newsletter/send-sequence", newsletter_send_sequence_post_216);
app.post("/api/newsletter/subscribe", newsletter_subscribe_post_217);
app.get("/api/newsletter/subscribers", newsletter_subscribers_get_218);
app.get("/api/newsletter/unsubscribe", newsletter_unsubscribe_get_219);
app.get("/api/og", og_get_220);
app.get("/api/settings/rates", settings_rates_get_221);
app.get("/api/settings/social", settings_social_get_222);
app.post("/api/test-email", test_email_post_223);
app.post("/api/users/2fa/setup", users_2fa_setup_post_224);
app.post("/api/users/2fa/verify", users_2fa_verify_post_225);
app.post("/api/users/avatar", users_avatar_post_226);
app.get("/api/users/balance", users_balance_get_227);
app.get("/api/users/beneficiaries", users_beneficiaries_get_228);
app.post("/api/users/beneficiaries/add", users_beneficiaries_add_post_229);
app.post("/api/users/beneficiaries/delete", users_beneficiaries_delete_post_230);
app.post("/api/users/beneficiaries/update", users_beneficiaries_update_post_231);
app.get("/api/users/cards", users_cards_get_232);
app.post("/api/users/cards/delete", users_cards_delete_post_233);
app.post("/api/users/cards/freeze", users_cards_freeze_post_234);
app.post("/api/users/cards/generate", users_cards_generate_post_235);
app.post("/api/users/cards/request", users_cards_request_post_236);
app.post("/api/users/deposit", users_deposit_post_237);
app.get("/api/users/devices", users_devices_get_238);
app.post("/api/users/devices/revoke", users_devices_revoke_post_239);
app.post("/api/users/kyc-document", users_kyc_document_post_240);
app.get("/api/users/kyc/status", users_kyc_status_get_240c);
app.post("/api/users/kyc/submit", users_kyc_submit_post_240d);
app.post("/api/users/kyc/upload-url", users_kyc_upload_url_post_240e);
app.post("/api/users/tickets", users_tickets_post_240b);
app.post("/api/users/login", users_login_post_241);
app.get("/api/users/login-history", users_login_history_get_242);
app.post("/api/users/logout", users_logout_post_243);
app.patch("/api/users/me", users_me_patch_244);
app.get("/api/users/notifications", users_notifications_get_245);
app.post("/api/users/notifications/delete", users_notifications_delete_post_246);
app.get("/api/users/notifications/preferences", users_notifications_preferences_get_247);
app.post("/api/users/notifications/preferences", users_notifications_preferences_post_248);
app.post("/api/users/notifications/read", users_notifications_read_post_249);
app.post("/api/users/password-reset", users_password_reset_post_250);
app.post("/api/users/password-reset/confirm", users_password_reset_confirm_post_251);
app.get("/api/users/profile", users_profile_get_252b);
app.put("/api/users/profile", users_profile_put_252);
app.post("/api/users/register", users_register_post_253);
app.get("/api/users/security/events", users_security_events_get_254);
app.get("/api/users/security/sessions", users_security_sessions_get_255);
app.post("/api/users/security/sessions/revoke", users_security_sessions_revoke_post_256);
app.get("/api/users/session", users_session_get_257);
app.get("/api/users/support", users_support_get_258);
app.post("/api/users/support", users_support_post_259);
app.post("/api/users/swap", users_swap_post_260);
app.get("/api/users/trading/alerts", users_trading_alerts_get_261);
app.post("/api/users/trading/alerts", users_trading_alerts_post_262);
app.get("/api/users/trading/analytics", users_trading_analytics_get_263);
app.get("/api/users/trading/history", users_trading_history_get_264);
app.get("/api/users/trading/market-data", users_trading_market_data_get_265);
app.get("/api/users/trading/orders", users_trading_orders_get_266);
app.post("/api/users/trading/orders", users_trading_orders_post_267);
app.post("/api/users/trading/orders/cancel", users_trading_orders_cancel_post_268);
app.get("/api/users/trading/portfolio", users_trading_portfolio_get_269);
app.get("/api/users/trading/summary", users_trading_summary_get_270);
app.get("/api/users/trading/watchlist", users_trading_watchlist_get_271);
app.post("/api/users/trading/watchlist", users_trading_watchlist_post_272);
app.get("/api/users/transactions", users_transactions_get_273);
app.post("/api/users/transfer", users_transfer_post_274);
app.get("/api/users/transfers", users_transfers_get_275);
app.post("/api/users/transfers", users_transfers_post_276);
app.get("/api/users/verify-email", users_verify_email_get_277);
app.get("/api/users/wallet-overview", users_wallet_overview_get_278);
app.post("/api/users/withdraw", users_withdraw_post_279);
app.get("/api/zoho/callback", zoho_callback_get_280);
app.get("/api/zoho/connect", zoho_connect_get_281);
app.get("/api/zoho/status", requireAdminAuth, zoho_status_get_282);
// </api-registrations>
...
app.use("/api", (err: unknown, req: Request, res: Response, _next: NextFunction) => {
	...
	const safeMethod = SAFE_METHODS.has(req.method) ? req.method : 'UNKNOWN';
...
// Not import.meta.env.PROD: Vite's SSR build does not reliably inline that
// constant as `true` for this entry file (it stayed a runtime-false check,
// dead-code-eliminating this entire block — including httpServer.listen —
// so the built bundle never actually started listening). NODE_ENV is a
...
if (process.env.NODE_ENV === 'production') {
  ...
  ready = (async () => {
	...
	// Runs on every boot; drizzle's migrator tracks what's already applied in
	// its own metadata table, so a clean DB is a no-op. Fails loudly (exits
	// non-zero) rather than silently swallowing an error and serving with a
	// stale/incomplete schema — see the cardStore/config-table incidents this
	...
	app.use((err: unknown, req: Request, res: Response, _next: NextFunction) => {
		...
		const SAFE_METHODS_2 = new Set(['GET','POST','PUT','PATCH','DELETE','HEAD','OPTIONS']);
		const safeMethod2 = SAFE_METHODS_2.has(req.method) ? req.method : 'UNKNOWN';
		console.error(JSON.stringify({ event: 'api.unhandled_error', path: req.path, method: safeMethod2, error: message, stack }));
	...
	httpServer.listen(port, host, () => {
		...
		// ── Startup: sync live secrets into SMTP config store ───────────────
		syncSecretsIntoConfig({
			clientId:     String(getSecret('ZOHO_CLIENT_ID')     || getSecret('CLIENTID')     || ''),
			clientSecret: String(getSecret('ZOHO_CLIENT_SECRET') || getSecret('CLIENTSECRET') || ''),
			refreshToken: String(getSecret('ZOHO_REFRESH_TOKEN') || getSecret('REFRESHTOKEN') || ''),
			accountId:    String(getSecret('ZOHO_ACCOUNT_ID')    || getSecret('USERID')       || ''),
		});
