...
async function run() {
  ...
  const requiredTables = ['users', 'transactions', 'cards', 'wallets', 'kyc_notes', 'trading_positions', 'trading_orders', 'notifications', 'support_conversations', 'login_events', 'audit_log', 'admin_sessions', 'customer_sessions'];
