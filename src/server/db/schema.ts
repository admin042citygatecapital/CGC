...
export const legalEntityProfiles = pgTable('legal_entity_profiles', {
  ...
  authorityReference: text('authority_reference'), authoritySha256: text('authority_sha256'), authorizedOfficerRef: text('authorized_officer_ref'),
  authorityIssuedAt: timestamp('authority_issued_at', { withTimezone: true }), authorityExpiresAt: timestamp('authority_expires_at', { withTimezone: true }),
