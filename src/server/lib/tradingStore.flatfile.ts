...
export function getPositions(userId: string): TradingPosition[] { return getAllPositions().filter(p => p.userId === userId); }
...
export function getOrders(userId: string): TradingOrder[] { return getAllOrders().filter(o => o.userId === userId); }
...
export function getTrades(userId: string): TradeRecord[] { return getAllTrades().filter(t => t.userId === userId); }
