/**
 * r2Storage.ts — DEPRECATED: Cloudflare R2 object storage integration
 *
 * ⚠️  THIS FILE IS DEPRECATED. Use supabaseStorage.ts instead.
 *
 * This file is kept for reference only. All upload/delete operations
 * have been migrated to supabaseStorage.ts which uses Supabase Storage
 * (Vercel-compatible, no Cloudflare dependency).
 *
 * No code in this project imports from r2Storage.ts anymore.
 * It will be removed in a future cleanup pass.
 *
 * Original purpose:
 *   Cloudflare R2 object storage via S3-compatible REST API.
