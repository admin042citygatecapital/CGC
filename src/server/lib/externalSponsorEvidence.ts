export type ExternalAuthorityType =
  | 'corporate_registry_and_authority'
  | 'certified_ownership_and_provider_verification'
  | 'qualified_uk_legal_counsel'
  | 'authorised_sponsor_institution'
  | 'executed_counterparty_agreement';
...
export const EXTERNAL_SPONSOR_EVIDENCE: readonly ExternalSponsorEvidenceRequirement[] = [
  {
    ...
    authorityType: 'corporate_registry_and_authority',
  },
  {
    ...
    authorityType: 'certified_ownership_and_provider_verification',
  },
  {
    ...
    authorityType: 'qualified_uk_legal_counsel',
  },
  {
    ...
    authorityType: 'authorised_sponsor_institution',
  },
  {
    ...
    authorityType: 'executed_counterparty_agreement',
  },
] as const;

export function externalRequirementForControl(controlKey: string): ExternalSponsorEvidenceRequirement | undefined {
  return EXTERNAL_SPONSOR_EVIDENCE.find(requirement => requirement.controlKey === controlKey);
}
