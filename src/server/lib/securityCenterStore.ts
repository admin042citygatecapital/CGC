...
const SYSTEM_ROLES: Role[] = [
  {
    ...
    permissions: ['dashboard.view','users.view','users.create','users.edit','users.delete','users.kyc',
      ...
      'security.view','security.manage','config.view','config.edit','trading.view','trading.manage',
      'rates.view','rates.manage','audit.view','admin.create','admin.delete'],
  ...
  },
  {
    ...
    permissions: ['dashboard.view','transactions.view','transactions.approve','transactions.reverse',
      'reports.view','reports.export','users.view','cards.view','trading.view','trading.manage',
      'rates.view','rates.manage'],
...
export const PERMISSION_CATALOGUE: PermissionDef[] = [
  ...
  // Trading
  { key: 'trading.view',            label: 'View Trading',             description: 'Read trading fee tiers, markets, providers, and platform freeze state.', group: 'Trading',      risk: 'low' },
  { key: 'trading.manage',          label: 'Manage Trading',           description: 'Set trading fees, create/suspend markets, freeze platform trading, configure providers.', group: 'Trading', risk: 'high' },
  // Rates
  { key: 'rates.view',              label: 'View Rates & Fees',        description: 'Read exchange rates, FX markups, tier fees, and withdrawal limits.',     group: 'Rates',         risk: 'low' },
  { key: 'rates.manage',            label: 'Manage Rates & Fees',      description: 'Set exchange rates, FX markups, transaction fees, tier fees, and withdrawal limits.', group: 'Rates', risk: 'high' },
  // Audit
