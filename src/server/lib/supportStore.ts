...
const DEFAULT_CANNED: CannedResponse[] = [
  ...
  },
  {
    ...
    body: "Your KYC documents have been received and are currently under review by our compliance team. This process typically takes 1–3 business days. We'll notify you once the review is complete.",
    createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
  },
  {
    id: 'cr_default_5', category: 'KYC',
    title: 'KYC Documents Required',
    body: "To complete your account verification, we require a valid government-issued photo ID and proof of address dated within the last 3 months. Please upload these documents in your account portal.",
    createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
  },
  {
    id: 'cr_default_6', category: 'Transfer Delays',
    title: 'Transfer Delay Explanation',
    body: "We understand your concern regarding the transfer delay. International wire transfers can take 1–5 business days depending on the receiving bank and country. Your funds are secure and being processed. We'll notify you once the transfer is complete.",
    createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
  },
  {
    id: 'cr_default_7', category: 'Card Issues',
    title: 'Card Issue Escalated',
    body: "We've escalated your card issue to our cards team. They will investigate and resolve this within 24 hours. If your card was compromised, we recommend freezing it immediately from your dashboard.",
    createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
  },
  {
    id: 'cr_default_8', category: 'Account Verification',
    title: 'Account Verification Steps',
    body: "To verify your account, please ensure your email address is confirmed and your KYC documents have been submitted. Once approved by our compliance team, your account will be fully activated.",
    createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
  },
];
