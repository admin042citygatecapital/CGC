...
const ROUTE_CATALOGUE: DeveloperRouteEntry[] = [
  ...
  { method:'GET',  path:'/api/admin/search',                      group:'Platform',         auth:'admin',   description:'Search masked customer, account, transaction, card and support summaries' },
  ...
  { method:'GET',  path:'/api/admin/legal-entity', group:'Compliance', auth:'admin', description:'Legal entity and beneficial-owner verification register' },
  { method:'POST', path:'/api/admin/legal-entity', group:'Compliance', auth:'admin', description:'Save, submit, or review the legal entity profile' },
  { method:'POST', path:'/api/admin/legal-entity/owners', group:'Compliance', auth:'admin', description:'Save, submit, or review opaque beneficial-owner records' },
  ...
  { method:'GET',  path:'/api/users/search',                       group:'Customer',         auth:'customer',description:'Search customer-owned transactions, statements, beneficiaries and help' },
