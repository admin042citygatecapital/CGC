...
import { getApplication, listApplicationEvents } from '../../../lib/applicationsStore.js';
...
export default async function handler(req: Request, res: Response): Promise<void> {
  ...
  res.json({
    ...
    application: {
      ...
      completionPct: app.completionPct, steps: app.steps, emailVerified: app.emailVerified,
