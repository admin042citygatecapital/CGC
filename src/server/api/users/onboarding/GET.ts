...
import { getOnboardingCaseBundle, getOnboardingQueuePosition, getOrCreateOnboardingCase } from '../../../lib/onboardingStore.js';
...
export default async function handler(req: Request, res: Response) {
  ...
  const queuePosition = await getOnboardingQueuePosition(record.id);
  return res.json({
    ...bundle,
