/**
 * POST /api/test-email
  * Admin-only endpoint. Auth is enforced by requireAdminAuth middleware in entry.ts.
 ...
 *
  * Rate-limited by the per-route testEmailRateLimit middleware in entry.ts (10 req/hr per IP).
 */
