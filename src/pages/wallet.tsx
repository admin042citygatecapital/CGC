...
const securityFeatures = [
  { icon: Lock,   title: 'Custody Status',       desc: 'Digital-asset custody is not currently active. A contracted and reviewed provider is required before activation.',       color: '#C9A84C' },
  ...
  { icon: RefreshCw, title: 'Monitoring Required', desc: 'Production fraud, sanctions and transaction monitoring are not currently connected.',                                color: '#10B981' },
  { icon: Zap,    title: 'Settlement Workflow',   desc: 'Review how settlement and conversion status will be presented after providers are approved.',                           color: '#9945FF' },
  ...
  { icon: ArrowLeftRight, title: 'Exchange Interface', desc: 'Compare supported digital assets and fiat currencies using transparent indicative rates and flags.', color: '#F7931A' },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore a unified digital-asset and fiat wallet interface using sample balances. Custody, trading and transfers require approved providers." />
        ...
        <meta property="og:description" content="Explore a unified digital-asset and fiat wallet interface using sample balances." />
        ...
        <meta name="twitter:description" content="Explore a unified digital-asset and fiat wallet interface with sample balances. Custody, exchange and transfers require approved providers." />
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          mainEntity: {
            ...
            description: 'A published digital-asset and fiat wallet interface using sample balances; custody and execution require approved providers.',
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-foreground/50 leading-relaxed mb-8">
                Explore digital-asset and fiat conversion workflows using indicative prices. Order execution, settlement and custody are currently unavailable.
              </p>
