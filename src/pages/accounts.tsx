  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content={(() => { const u = new URL('/api/og', 'https://citygate.capital'); u.searchParams.set('title', 'Open a Bank Account'); u.searchParams.set('description', 'Personal, Savings 5.2% APY & Business Accounts'); return u.href; })()} />
        ...
        <meta name="twitter:image" content={(() => { const u = new URL('/api/og', 'https://citygate.capital'); u.searchParams.set('title', 'Open a Bank Account'); u.searchParams.set('description', 'Personal, Savings 5.2% APY & Business Accounts'); return u.href; })()} />
        <script type="application/ld+json">{JSON.stringify({
          ...
          mainEntity: {
            ...
            itemListElement: [
              { '@type': 'ListItem', position: 1, item: { '@type': 'FinancialProduct', name: 'Personal Account', description: 'Free multi-currency personal checking account with crypto wallet.', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } },
              { '@type': 'ListItem', position: 2, item: { '@type': 'FinancialProduct', name: 'Savings Account', description: 'High-yield savings account with 5.2% APY, no lock-up, FDIC insured.', offers: { '@type': 'Offer', price: '0', priceCurrency: 'USD' } } },
              { '@type': 'ListItem', position: 3, item: { '@type': 'FinancialProduct', name: 'Business Account', description: 'Full-featured business banking with team access, expense management, and API.', offers: { '@type': 'Offer', price: '19', priceCurrency: 'USD', billingIncrement: 'P1M' } } },
            ],
          },
        })}</script>
        <script type="application/ld+json">{JSON.stringify({
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-foreground/45 max-w-md mx-auto text-sm">All accounts include zero-fee crypto, multi-currency wallets, and instant transfers.</p>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {accountTypes.map((type, i) => (
              ...
              >
                ...
                <p className="text-sm text-foreground/45 leading-relaxed mb-6">{type.desc}</p>
              ...
              <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full min-w-[560px]">
                    <thead>
                      <tr>
                        <th className="text-left py-4 pr-6 text-xs text-foreground/30 uppercase tracking-widest font-semibold w-1/3">Feature</th>
                        {accountTypes.map(t => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              ...
              <p className="text-foreground/45 max-w-md mx-auto text-sm">AI-powered identity verification means no waiting, no paperwork, no branch visits. Ever.</p>
            </motion.div>
          </div>
      ...
      <section className="py-24 pb-40 md:pb-24 bg-[#060606]">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-foreground/45 mb-8 max-w-md mx-auto relative text-sm leading-relaxed">
