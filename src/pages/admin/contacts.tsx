...
export default function AdminContacts() {
  ...
  return (
    <>
      <Helmet><title>Contact Submissions — CGC Admin</title><meta name="description" content="View and manage contact form submissions." /><meta name="robots" content="noindex, nofollow" /><link rel="canonical" href="https://citygate.capital/admin/contacts" /></Helmet>
