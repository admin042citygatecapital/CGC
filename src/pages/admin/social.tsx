...
export default function AdminSocial() {
  ...
  return (
    <>
      <Helmet><title>Social Media — CGC Admin</title><meta name="description" content="Social media settings and integrations for City Gate Capital." /><meta name="robots" content="noindex, nofollow" /><link rel="canonical" href="https://citygate.capital/admin/social" /></Helmet>
