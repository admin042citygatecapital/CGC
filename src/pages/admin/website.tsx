...
const DEFAULT: WebsiteSettings = {
  ...
  logoUrl: '/assets/IMG-20260519-WA0000.jpg',
  faviconUrl: '/assets/IMG-20260519-WA0000.jpg',
  primaryColor: '#C9A84C',
  accentColor: '#627EEA',
...
export default function AdminWebsite() {
  ...
  return (
    <>
      <Helmet><title>Website Settings — CGC Admin</title><meta name="robots" content="noindex" /></Helmet>
              ...
              <>
                ...
                {cfg.logoUrl && (
                  <div className="p-4 rounded-xl border border-white/8 flex items-center gap-4" style={{ background: 'rgba(0,0,0,0.3)' }}>
                    <img src={cfg.logoUrl} alt="Logo preview" className="h-12 w-auto object-contain" loading="lazy" />
                    <div>
