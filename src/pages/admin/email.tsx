...
const TEMPLATE_ICONS: Record<string, React.ElementType> = {
  ...
  application_under_review:    Clock,
  application_needs_information: AlertCircle,
  application_approved:    CheckCircle,
  application_activation_pending: Clock,
...
const TEMPLATE_COLORS: Record<string, string> = {
  ...
  kyc_approved:         '#10B981',
  kyc_rejected:         '#EF4444',
  application_received:    '#06B6D4',
  application_under_review:    '#F59E0B',
  application_needs_information: '#F59E0B',
  application_approved:    '#10B981',
  application_activation_pending: '#F59E0B',
