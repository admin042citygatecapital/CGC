...
interface Readiness { package: { id: string; version: string; status: string; label: string }; productProfile: { currencies: readonly string[]; audiences: readonly string[]; excluded: readonly string[]; phases: ReadonlyArray<{ phase: number; name: string; scope: string }> }; controls: Control[]; externalEvidenceRequirements: ExternalRequirement[]; summary: { total: number; approved: number; outstanding: number; percent: number; fullyReviewed: boolean; sponsorSubmissionReady: boolean }; financialOperationsLocked: boolean; }
