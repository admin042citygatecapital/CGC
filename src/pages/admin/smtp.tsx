...
import {
  ...
  ArrowRight, AlertCircle, Clock, TrendingUp,
} from 'lucide-react';
...
export default function SmtpManagementPage() {
  ...
  const [activeTab, setActiveTab] = useState<'status' | 'config' | 'test' | 'queue' | 'override'>('status');
  ...
  }, [fetchStatus, fetchConfig, fetchLogs, activeTab]);
  ...
  return (
    <AdminLayout title="SMTP Management">
      <Helmet><title>SMTP Management — CGC Admin</title><meta name="robots" content="noindex" /></Helmet>
