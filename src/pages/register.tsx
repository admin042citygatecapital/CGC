      ...
      <>
        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-16 bg-background">
          <motion.div
            ...
            className="w-full max-w-md rounded-3xl border border-[#C9A84C]/30 p-10 text-center"
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-16 bg-background">
        ...
        >
          <div className="rounded-3xl border border-[#C9A84C]/30 p-8 md:p-10"
            ...
            <div className="flex items-center gap-3 mb-8">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-foreground font-bold text-base tracking-tight">City Gate</span>
                <span className="text-xs font-semibold tracking-[0.15em] uppercase" style={{ color: '#C9A84C' }}>Capital</span>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/[0.07] border border-gray-600 text-foreground text-sm placeholder:text-foreground/25 focus:outline-none focus:border-primary/50 transition-colors"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/[0.07] border border-gray-600 text-foreground text-sm focus:outline-none focus:border-primary/50 transition-colors appearance-none"
                  >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-11 py-3 rounded-xl bg-white/[0.07] border border-gray-600 text-foreground text-sm placeholder:text-foreground/25 focus:outline-none focus:border-primary/50 transition-colors"
                  />
